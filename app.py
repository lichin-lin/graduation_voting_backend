...
def vote():
    ...
    if voting_result is None:
        ...
        writeLog('create new voting record- user:' + str(memberID) + 'vote song: ' + str(songID))
        print('create new voting record- user:', memberID, ' , songID: ', songID)
        return jsonify('vote!'), 200
    else:
        writeLog('you already vote: song- user:' + str(voting_result[0]) + 'vote song: ' + str(voting_result[1]))
